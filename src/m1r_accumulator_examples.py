...
#
#              for k in range(r - s):      r-s should be r-s+1
#                  count = 0               belongs before the loop
#                  if math.cos(r) > 0:     math.cos(r+k) [not just r]
#                      count = 1           count=count+1 [accumulate]
#                  return count            belongs after the loop
#
...
#                  center = rg.Point(x + (k * diameter), y)
#                  circle = rg.Circle(point, radius)
#                  circle.attach_to(window)                     correct
#                  x = x + (2 * radius)
#
###############################################################################
