...
def run_test_factorial():
    ...
    # -------------------------------------------------------------------------
    # Test 3:
    answer_from_oracle = math.factorial(27)
    answer_from_my_code = factorial(27)
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 2
    answer = count_cosines_from(5, 7, 0.30)
    ...
    # Test 4:
    expected = 2
    answer = count_cosines_from(11, 15, 0.31)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 6
    answer = count_cosines_from(7, 22, 0.29)
